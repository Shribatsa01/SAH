...
<?php
					...
					$division = $_POST['division'];
						...
						if($er == 0)
						{
							...
							$sql = "INSERT INTO student (sname, gname, contact, email, address, shift, gender, blgroup, division) VALUES (
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="right-side-form">
										...
										<input type="radio" name="gender" value="male"><span style="color: #000000; font-size: 20px">Male</span>
										<input type="radio" name="gender" value="female"><span style="color: #000000; font-size: 20px">Female</span>
										<input type="radio" name="gender" value="others"><span style="color: #000000; font-size: 20px">Others</span>
										<span class="error">
										...
										<p><select name="division" id="">
												...
												<option value="1">Bachelor of Computer Science and Engineering</option>
												<option value="2">Bachelor of Mechanical Engineering</option>
												<option value="3">Bachelor of Civil Engineering</option>
												<option value="4">Bachelor of Electrical and electronics engineering</option>
												<option value="5">Bachelor of Electrical and communications engineering</option>
												<option value="6">Bachelor of Business Administration </option>
												<option value="7">Bachelor of Agriculture Engineering</option>
												<option value="8">Bachelor in Chemical Engineering</option>
												</select><span class="error">
